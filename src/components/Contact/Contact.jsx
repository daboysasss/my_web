    ...
    <section id="contact" className="contact-section">
      ...
      <div className="contact-container">
        <div className="contact-info">
          <h3 className="info-title">Let's discuss something awesome.</h3>
          <p className="info-text">
            I am always open to discussing new web applications, design systems, open source collaborations, or remote opportunities.
          </p>
          ...
          <div className="contact-methods">
            <div className="method-item">
              ...
              <div className="method-content">
                ...
                <a href="mailto:your.email@gmail.com" className="method-link">your.email@gmail.com</a>
              </div>
            </div>
            ...
            <div className="method-item">
              ...
              <div className="method-content">
                ...
                <a href="https://github.com/daboysasss" target="_blank" rel="noopener noreferrer" className="method-link">github.com/daboysasss</a>
              </div>
            </div>
            ...
            <div className="method-item">
              ...
              <div className="method-content">
                ...
                <a href="https://www.linkedin.com/in/arsenii-bocharnikov-087b3235b?utm_source=share_via&utm_content=profile&utm_medium=member_ios" target="_blank" rel="noopener noreferrer" className="method-link">linkedin.com/in/arsenii-bocharnikov</a>
              </div>
            </div>
          </div>
        </div>
          ...
          <form onSubmit={handleSubmit} className="contact-form">
            ...
            <div className="form-group">
              ...
              <textarea
                ...
                onChange={handleChange}
                placeholder="Hey! I'd like to work with you..."
                rows="5"
