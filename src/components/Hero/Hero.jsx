  ...
  return (
    <section id="home" className="hero">
      <h1 className="hero-title">
        <span className="title-top">Software</span>
        <span className="title-bottom">Engineer</span>
      </h1>
      ...
      <p className="hero-subtitle">
        Building elegant, modern, and high-performance web applications.
      </p>

      <div className="hero-actions">
        <a href="/cv.pdf" className="action-btn cv-btn" download>
      ...
      <div className="hero-socials">
        <a href="https://github.com/daboysasss" target="_blank" rel="noopener noreferrer" className="social-btn github">
        ...
        <a href="https://www.linkedin.com/in/arsenii-bocharnikov-087b3235b?utm_source=share_via&utm_content=profile&utm_medium=member_ios" target="_blank" rel="noopener noreferrer" className="social-btn linkedin">
        ...
        <a href="mailto:your.email@gmail.com" className="social-btn gmail">
